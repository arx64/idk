...
<body class="  pace-done" bgcolor="Blue"><div class="pace  pace-inactive"><div class="pace-progress" data-progress-text="100%" data-progress="99" style="width: 100%;">
...
echo '<font color="green">berhasil boy</font><br />';
}else{
echo '<font color="red">server kayak🐖</font><br />';
}
}
